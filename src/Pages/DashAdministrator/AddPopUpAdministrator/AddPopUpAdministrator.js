...
import StyleAddPopUp from "./AddPopUpAdministrator.module.css";
import { useTeamsStore } from "../../../Zustand/Store";

function AddPopUpAdministrator({ handleCancelAdd, handleFormSubmitPlayer }) {
...
export default AddPopUpAdministrator;
