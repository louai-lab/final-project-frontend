...
import StyleAddPopUp from "./AddPopUpTitle.module.css";
import { Box, Button, FormControl, Stack, TextField } from "@mui/material";

function AddPopUpTitle({ handleCancelAdd, handleFormSubmitTitle }) {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    handleFormSubmitTitle(formData);
  };
